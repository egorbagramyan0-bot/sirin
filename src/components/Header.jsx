...
export default function Header({ onNavigate, onLogoClick, activeIndex }) {
  ...
  return (
    <>
      <header 
        ref={headerRef}
        className="site-header fixed top-0 left-0 w-full z-50 h-[76px] grid grid-cols-[1fr_auto_1fr] items-center px-6 md:px-11 pointer-events-auto"
      >
        {/* Left: Spacer */}
        <div />

        {/* Center: Desktop Nav Pill */}
        <nav className="nav nav-pill justify-self-center desktop-nav-only flex items-center gap-1 p-1 bg-white/68 border border-black/8 rounded-full backdrop-blur-[14px] shadow-[0_10px_30px_rgba(0,0,0,0.04)]">
