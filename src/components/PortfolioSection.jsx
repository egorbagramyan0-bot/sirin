...
const projects = [
  {
    title: 'Лидер Юг',
    category: 'Корпоративный сайт / грузоперевозки',
    desc: 'Сайт для логистической компании в сфере грузоперевозок с чистой структурой, понятной подачей услуг и акцентом на надежность. Основная задача — быстро донести логистические возможности компании, показать опыт и привести пользователя к расчету стоимости перевозки.',
